...
%gcc% .\mainFile.c -o .\mainFile -L ".\dependencies\lib\windows" -I ".\dependencies\include" -lfile -lerror -lrecord -ldir_mgmt -ldate_time -ansi --std=c99 -static -Wall -pedantic